...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', home = '" . (int)$data['home'] . "', fire_bar = '" . (int)$data['fire_bar'] . "', bottom = '" . (int)$data['bottom'] . "', startdate = '" . $this->db->escape($data['startdate'])  . "', enddate = '" . $this->db->escape($data['enddate'])  . "', status = '" . (int)$data['status'] . "'");
	...
	public function editInformation($information_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', home = '" . (int)$data['home'] . "', fire_bar = '" . (int)$data['fire_bar'] . "', bottom = '" . (int)$data['bottom'] . "', startdate = '" . $this->db->escape($data['startdate']) . "', enddate = '" . $this->db->escape($data['enddate']) . "', status = '" . (int)$data['status'] . "' WHERE information_id = '" . (int)$information_id . "'");
