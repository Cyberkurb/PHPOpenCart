...
//AWS
// HTTP
define('HTTP_SERVER', 'https://admin.pitboss-grills.com/');
define('HTTP_CATALOG', 'https://pitboss-grills.com/');
define('HTTP_IMAGE', 'https://dj4htnsq11to6.cloudfront.net/' );
// HTTPS
define('HTTPS_SERVER', 'https://admin.pitboss-grills.com/');
define('HTTPS_CATALOG', 'https://pitboss-grills.com/');
