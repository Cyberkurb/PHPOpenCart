<?php
class ControllerExtensionThemeJjsuperstore extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('extension/theme/jjsuperstore');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('theme_jjsuperstore', $this->request->post, $this->request->get['store_id']);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/theme/jjsuperstore', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $this->request->get['store_id'], true)
		);
		...
		if (isset($this->request->get['store_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$setting_info = $this->model_setting_setting->getSetting('theme_jjsuperstore', $this->request->get['store_id']);
		}
		
		if (isset($this->request->post['theme_jjsuperstore_directory'])) {
			$data['theme_jjsuperstore_directory'] = $this->request->post['theme_jjsuperstore_directory'];
		} elseif (isset($setting_info['theme_jjsuperstore_directory'])) {
			$data['theme_jjsuperstore_directory'] = $setting_info['theme_jjsuperstore_directory'];
		} else {
			$data['theme_jjsuperstore_directory'] = 'jjsuperstore';
		}		
		...
		if (isset($this->request->post['theme_jjsuperstore_status'])) {
			$data['theme_default_status'] = $this->request->post['theme_jjsuperstore_status'];
		} elseif (isset($setting_info['theme_jjsuperstore_status'])) {
			$data['theme_default_status'] = $setting_info['theme_jjsuperstore_status'];
		} else {
			$data['theme_jjsuperstore_status'] = '';
		}
		...
		if (isset($this->request->post['theme_default_image_thumb_width'])) {
			...
			$data['theme_default_image_thumb_width'] = 400;
		}
		...
		if (isset($this->request->post['theme_default_image_thumb_height'])) {
			...
			$data['theme_default_image_thumb_height'] = 600;		
		}
		...
		if (isset($this->request->post['theme_default_image_popup_width'])) {
			...
			$data['theme_default_image_popup_width'] = 700;
		}
		...
		if (isset($this->request->post['theme_default_image_popup_height'])) {
			...
			$data['theme_default_image_popup_height'] = 900;
		}
		...
		if (isset($this->request->post['theme_default_image_product_width'])) {
			...
			$data['theme_default_image_product_width'] = 500;
		}
		...
		if (isset($this->request->post['theme_default_image_product_height'])) {
			...
			$data['theme_default_image_product_height'] = 700;
		}
		...
		if (isset($this->request->post['theme_default_image_additional_width'])) {
			...
			$data['theme_default_image_additional_width'] = 100;
		}
		...
		if (isset($this->request->post['theme_default_image_additional_height'])) {
			...
			$data['theme_default_image_additional_height'] = 200;
		}
		...
		if (isset($this->request->post['theme_default_image_related_width'])) {
			...
			$data['theme_default_image_related_width'] = 100;
		}
		...
		if (isset($this->request->post['theme_default_image_related_height'])) {
			...
			$data['theme_default_image_related_height'] = 200;
		}
		...
		if (isset($this->request->post['theme_default_image_compare_width'])) {
			...
			$data['theme_default_image_compare_width'] = 100;
		}
		...
		if (isset($this->request->post['theme_default_image_compare_height'])) {
			...
			$data['theme_default_image_compare_height'] = 200;
		}
