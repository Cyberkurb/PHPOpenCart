 ...
 *    this is a submodule of d_blog_module and is part of d_blog_module_pack extension.
 */

class ControllerExtensionModuleDBlogModuleCategory extends Controller {
    private $codename = 'd_blog_module_category';
    ...
    public function index(){
        ...
        //get setting
        $data['setting'] = $this->model_extension_module_d_blog_module_category->getConfigData($this->codename, $this->codename.'_setting', $this->store_id, $this->config_file);
        $data['config_files'] = $this->model_extension_module_d_blog_module_category->getConfigFiles($this->codename);
