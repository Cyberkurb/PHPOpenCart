...
class ControllerExtensionModuleDBlogModuleRelatedProduct extends Controller {
    private $codename = 'd_blog_module_related_product';
    ...
    public function index() {
       ...
       // Breadcrumbs
        ...
        //get setting
        $data['setting'] = $this->model_extension_module_d_blog_module_related_product->getConfigData($this->codename, $this->codename.'_setting', $this->store_id, $this->config_file);
        $data['config_files'] = $this->model_extension_module_d_blog_module_related_product->getConfigFiles($this->codename);
