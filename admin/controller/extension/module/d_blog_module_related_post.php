...
class ControllerExtensionModuleDBlogModuleRelatedPost extends Controller {
    private $codename = 'd_blog_module_related_post';
       ...
       // Breadcrumbs
        ...
        if (isset($this->request->post[$this->codename.'_status'])) {
            ...
            $data[$this->codename.'_status'] = $this->config->get($this->codename.'_status');
                ...
                //get setting
        $data['setting'] = $this->model_extension_module_d_blog_module_related_post->getConfigData($this->codename, $this->codename.'_setting', $this->store_id, $this->config_file);
        
        //get config 
        $data['config_files'] = $this->model_extension_module_d_blog_module_related_post->getConfigFiles($this->codename);
