...
{
    private $codename = 'd_blog_module_latest_posts';
    ...
    public function index() {
        ...
        //get setting
        // $data['setting'] = $this->model_extension_module_d_blog_module_latest_posts->getConfigData($this->codename, $this->codename.'_setting', $this->store_id, $this->config_file);

        //get config 
        // $data['config_files'] = $this->model_extension_module_d_blog_module_latest_posts->getConfigFiles($this->codename);
