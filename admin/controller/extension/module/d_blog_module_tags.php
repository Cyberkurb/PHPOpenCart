...
class ControllerExtensionModuleDBlogModuleTags extends Controller {
    private $codename = 'd_blog_module_tags';
    ...
    public function index(){
       ...
       // Breadcrumbs
        ...
        //get setting
        $data['setting'] = $this->model_extension_module_d_blog_module_tags->getConfigData($this->codename, $this->codename.'_setting', $this->store_id, $this->config_file);
        
        //get config 
        $data['config_files'] = $this->model_extension_module_d_blog_module_tags->getConfigFiles($this->codename);
