<link rel="stylesheet" href="./controller/extension/module/youtube-gallery-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="youtube-gallery-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Youtube Gallery</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/youtube-gallery-assets/popup.js';
