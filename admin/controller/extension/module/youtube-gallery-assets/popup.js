(function($) {
    ...
    let $deactivateForm  = jQuery('#youtube-gallery-deactivateForm');
    ...
    let deactivateFormSubmitted = localStorage.getItem('youtube-gallery-deactivateFormSubmitted');
    ...
    function submitForm(deactivate_options, id) {
        ...
        data.push({name: 'action', value: 'youtube-gallery-deactivate'});
        ...
        if (!deactivateFormSubmitted) {
            localStorage.setItem('youtube-gallery-deactivateFormSubmitted', true);
            deactivateFormSubmitted = true;

            jQuery.post('./controller/extension/module/elfsight_youtube_gallery.php', jQuery.param(data)).then(function(result) {
