...
*/
class ControllerExtensionModuleDBlogModulePopularPosts extends Controller {
    private $codename = 'd_blog_module_popular_posts';
    private $route = 'extension/module/d_blog_module_popular_posts';
    ...
    public function index() {
        ...
        // $module_info = $this->config->get($this->codename);
        if (isset($this->request->post[$this->codename]['limit'])) {
            $data['limit'] = $this->request->post[$this->codename]['limit'];
        } elseif (isset($setting['limit'])) {
        ...
        if (isset($this->request->post[$this->codename]['blog_category'])) {
            $data['blog_category'] = $this->request->post[$this->codename]['blog_category'];
        } elseif (isset($setting['blog_category'])) {
            $data['blog_category'] = $setting['blog_category'];
        } else{
            $data['blog_category'] = array();
        }
        
        foreach ($data['blog_category'] as $key => $category) {
            $category_info = $this->model_extension_d_blog_module_category->getCategory($category);
            $data['blog_category'][$key] = array(
        ...
        // //get setting
        // $data['setting'] = $this->model_extension_module_d_blog_module_popular_posts->getConfigData($this->codename, $this->codename.'_setting', $this->store_id, $this->config_file);
        // //get config 
        // $data['config_files'] = $this->model_extension_module_d_blog_module_popular_posts->getConfigFiles($this->codename);
    ...
    private function validate($permission = 'modify') {
        ...
        if(empty($this->request->post[$this->codename]['limit']))
        {
