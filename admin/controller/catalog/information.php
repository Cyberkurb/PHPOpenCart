...
class ControllerCatalogInformation extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['home'])) {
			...
			$data['home'] = $information_info['home'];
		} else {
			$data['home'] = 0;
		}
		
		if (isset($this->request->post['fire_bar'])) {
			$data['fire_bar'] = $this->request->post['fire_bar'];
		} elseif (!empty($information_info)) {
			$data['fire_bar'] = $information_info['fire_bar'];
		} else {
			$data['fire_bar'] = 0;
		}
		...
		if (isset($this->request->post['startdate'])) {
			...
			$data['startdate'] = ($information_info['startdate'] != '0000-00-00') ? $information_info['startdate'] : '';
		} else {
			$data['startdate'] = '';
		}
		...
		if (isset($this->request->post['enddate'])) {
			...
			$data['enddate'] = ($information_info['enddate'] != '0000-00-00') ? $information_info['enddate'] : '';
		} else {
			$data['enddate'] = '';
		}
