...
class ControllerCatalogCategory extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_user_activity->addActivity('create_category', 'categoryID '.$category_id);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_user_activity->addActivity('update_category', 'categoryID '.$this->request->get['category_id']);
			$this->session->data['success'] = $this->language->get('text_success');
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $category_id) {
                ...
                $this->model_user_activity->addActivity('delete_category', 'categoryID '.$category_id);
			}
