...
class ControllerLocalisationOrderStatus extends Controller {
	...
	protected function getForm() {
		...
		$this->document->addStyle('view/javascript/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css');
		$this->document->addScript('view/javascript/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js');
		...
		if (isset($this->request->post['color_code'])) {
			...
			$data['color_code'] = $this->model_localisation_order_status->getColorCode($this->request->get['order_status_id']);
		} else {
			$data['color_code'] = "";
		}
