...
class ControllerUserUser extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_user_activity->addActivity('update_userPassword', $this->request->post['username'].'(userId '.$this->request->get['user_id'].')');
        }
        // Add to activity log
        $this->load->model('user/activity');

        $this->model_user_activity->addActivity('update_userDetails', $this->request->post['username'].'(userId '.$this->request->get['user_id'].')');
			$this->session->data['success'] = $this->language->get('text_success');
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $user_id) {
                ...
                $this->model_user_activity->addActivity('delete_user', 'userId '.$user_id);
			}
