...
class ControllerAccountOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			foreach ($products as $product) {
                ...
                $status_info = $this->model_account_order->getOrderStatusInfo($this->request->get['order_id'], $product['order_product_id']);
	...
	public function infoview() {
		...
		$order_info = $this->model_account_order->getOrderview($order_id);
