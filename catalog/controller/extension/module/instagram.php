...
class ControllerExtensionModuleInstagram extends Controller {
	public function index() {
		...
		$file = 'https://images.pitboss-grills.com/javascript/instagram/css/mycustom.css';
		...
		$this->document->addStyle('https://images.pitboss-grills.com/javascript/instagram/settings.css');

		$this->document->addStyle('https://images.pitboss-grills.com/javascript/instagram/slick/slick.css');
		$this->document->addStyle('https://images.pitboss-grills.com/javascript/instagram/slick/slick-theme.css');

		if( file_exists($file) ){
			$this->document->addStyle('https://images.pitboss-grills.com/javascript/instagram/css/mycustom.css');
		}else{			
			$this->document->addStyle('https://images.pitboss-grills.com/javascript/instagram/css/custom.css');
		}

		$this->document->addScript('https://images.pitboss-grills.com/javascript/instagram/slick/slick.min.js');
