	...
	protected function getForm() {
		...
		if (isset($this->request->post['information_layout'])) {
			...
			$data['information_layout'] = array();
				...
				if (isset($this->request->post['information_layout_style'])) {
					$data['information_layout_style'] = $this->request->post['information_layout_style'];
				} elseif (isset($this->request->get['information_id'])) {
					$data['information_layout_style'] = $this->model_catalog_information->getInformationLayoutStyle($this->request->get['information_id']);
				} else {
					$data['information_layout_style'] = array();
				}
