		...
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/information')) {		
				...
				$catalog[] = array(
					...
					'href'     => $this->url->link('extension/rciextension/faq/dashboard', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
				$this->load->language('common/column_left');
				...
				$catalog[] = array(
					'name'	   => $this->language->get('text_sizing'),
					'href'     => $this->url->link('extension/rciextension/sizing/dashboard', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
				$this->load->language('common/column_left');
				...
				$catalog[] = array(
					'name'	   => $this->language->get('text_technology'),
					'href'     => $this->url->link('extension/rciextension/technology/dashboard', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
				$this->load->language('common/column_left');
			...
			if ($this->user->hasPermission('access', 'marketplace/event')) {
				...
				if ($rciextensions) {
					...
					$marketplace[] = array(
						'name'	   => $this->language->get('text_rciextension'),
						'href'     => '',
						'children' => $rciextensions
					);
				}
            ...
            if ($module['setting']['status']) {
                $data['menus'][] = array(
                    ...
                    'name'     => 'iBlog',
                    'href'     => $this->url->link($module['path'], 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            //=== ISL iBlogs :: end
