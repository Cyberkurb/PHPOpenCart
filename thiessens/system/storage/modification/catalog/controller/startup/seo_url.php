...
class ControllerStartupSeoUrl extends Controller {
	public function index() {
                ...
                $iblogs = $this->load->controller('extension/module/iblogs_seo_url/index');
                if (!empty($iblogs['redirect'])) {
                    $this->response->redirect($iblogs['redirect']);
                } elseif (!empty($iblogs['action'])) {
                    if ($this->config->get('config_seo_url')) {
                        $this->url->addRewrite($this);
                    }
                    return new Action($iblogs['action']);
                }
	...
	public function rewrite($link) {
                ...
                $iblogs_url = $this->load->controller('extension/module/iblogs_seo_url/rewrite', $link);
                if (!empty($iblogs_url)) { return $iblogs_url; }
