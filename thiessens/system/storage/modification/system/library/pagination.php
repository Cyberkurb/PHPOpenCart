...
class Pagination {
	...
	public $num_links = 8;
	public $url = '';
	public $text_first = '<i class="fal fa-angle-double-left"></i>';
	public $text_last = '<i class="fal fa-angle-double-right"></i>';
	public $text_next = '<i class="fal fa-angle-right"></i>';
	public $text_prev = '<i class="fal fa-angle-left"></i>';
