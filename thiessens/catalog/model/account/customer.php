...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$ch = curl_init("https://thiessens.com/activecamp_add.php?customer_id=".$customer_id);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
		curl_exec($ch);
		curl_close($ch);

		$ch = curl_init("https://thiessens.com/transfer-accountv2.php?customer_id=".$customer_id);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
