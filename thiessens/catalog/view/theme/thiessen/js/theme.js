...
$(document).ready(function() {
    ...
    var $div = $("<ul class='list-unstyled'></ul>").appendTo('.footer-categories'),
        code;
    ...
    if (isIE) {
        /* hide mobile menu if browser is IE */
        $("#mobile-menu").hide();
    } else {
        /* init mobile menu for non IE browsers */
    ...
    jQuery(".top-header-text").clone().appendTo("#mobile-menu");
});
