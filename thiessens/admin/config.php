...
// HTTP
define('HTTP_SERVER', 'https://admin.thiessens.com/');
define('HTTP_CATALOG', 'https://thiessens.com/');

// HTTPS
define('HTTPS_SERVER', 'https://admin.thiessens.com/');
define('HTTPS_CATALOG', 'https://thiessens.com/');
