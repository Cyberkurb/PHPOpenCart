...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>ELEKTPRO UAB</h3>
            <p class="font-weight-light mb-0">Kauno g. 45-33<br>
            Klaipeda<br>
            Lithuania LT-91170<br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">pardavimai@palapiniumagnatai.lt</span></i>
            </p><br><br>
        </section>
        </div>
        <!--<div class="col-lg-6">-->
        ...
        <!--    <br>-->
        <!--    <img src='https://images.pitboss-grills.com/catalog/icons/mapicon.png' style="max-width:40px;">-->
        <!--    <h3>Manfira UAB<br><br></h3>-->
        <!--    <p class="font-weight-light mb-0">Lkauno g 32 a<br>-->
        <!--    Vilnius<br>-->
        <!--    Lithuania LT-14191<br>-->
        <!--      <i class="icon-phone"> 37063311451</i><br>-->
        <!--      <i class="icon-envelope-open"> <span style="font-size:.9rem;">info@grillman.lt</span></i>-->
        <!--    </p><br><br>-->
        <!--    <a class="btn btn-dark" href="http://www.grillman.lt">Shop Pit Boss Products</a><br><br>-->
        <!--</section>-->
        <!--</div>-->
...
<!--            <img src='https://images.pitboss-grills.com/catalog/icons/mapicon.png' style="max-width:40px;">-->
<!--            <h3>UAB "Agapi LT"</h3>-->
<!--            <p class="font-weight-light mb-0">Bajoru sodu 25<br>-->
<!--            Vilnius<br>-->
<!--            Lithuania LT-14191<br>-->
<!--              <i class="icon-phone">+370 (659) 69693</i><br>-->
<!--              <i class="icon-envelope-open"> <span style="font-size:.9rem;">info@agapi.lt</span></i>-->
<!--            </p><br><br>-->
<!--            <a class="btn btn-dark" href="http://www.agapi.lt">Shop Pit Boss Products</a><br><br>-->
<!--        </section>-->
<!--        </div>-->
<!--        <div class="col-lg-6">-->
<!--        <section class="features-icons bg-light text-center" id="dealer-section">-->
