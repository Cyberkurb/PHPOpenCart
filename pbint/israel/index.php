...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>Rokach - Heating Devices</h3>
            <p class="font-weight-light mb-0">Haisidot Road 30<br>
            Golan Heights 129100 Israel<br>
              <i class="icon-phone">074-7505520</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">sales @rokach.co.il</span></i>
            </p>
            <a class="btn btn-dark" href="https://www.rokach.co.il/group/pit-boss-%d7%a4%d7%99%d7%98%d7%91%d7%95%d7%a1/">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
    </div>
</div>
