...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>BARBECUE WORLD SPAIN</h3>
            <p class="font-weight-light mb-0">CALLE JUAN DE MENA 18   POLIGONO INDUSTRIAL<br>
            ESTEPONA MALAGA SPAIN 29680<br>
              <i class="icon-phone">0034 687940966</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">info@barbecueworld.es</span></i>
            </p>
            <a class="btn btn-dark" href="https://www.barbecueworld.es">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
    </div>
</div>
