...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>Fire & Food BBQ Store<br><br></h3>
            <p class="font-weight-light mb-0">Unit 8 Bracewell Avenue<br>
            Poulton<br>
            FY6 8JF<br>
              <i class="icon-phone">0161 424 9940</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">Info@Fireandfoodbbqstore.co.uk</span></i>
            </p><br><br>
            <a class="btn btn-dark" href="https://fireandfoodbbqstore.co.uk/brands/pit-boss/">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
        <div class="col-lg-4">
        <section class="features-icons bg-light text-center" id="dealer-section">
            <br>
            <img src='https://images.pitboss-grills.com/catalog/icons/mapicon.png' style="max-width:40px;">
            <h3>Buff BBQ <br><br></h3>
            <p class="font-weight-light mb-0">1 LONDON WAY MELBOURN<br>
             HERTFORDSHIRE<br>
             SG8 6DJ<br>
              <i class="icon-phone">0161 424 9940</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">Info@BuffBBQ.com</span></i>
            </p><br><br>
            <a class="btn btn-dark" href="https://www.BuffBBQ.com">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
</div><br><br>
...
<div class="row">
        <div class="col-lg-6">
            <section class="features-icons bg-light text-center" id="dealer-section">
                <br>
                <img src='https://images.pitboss-grills.com/catalog/icons/mapicon.png' style="max-width:40px;">
                <h3>A & N Fireplace Services Ltd</h3>
                <p class="fASDA ont-weight-light mb-0">Badby Lane<br>
                    Staverton,<br>
                    NN11 6DE<br>
                    United Kingdom<br>
                </p>
                <br>
                <br>
                <a class="btn btn-dark" href="https://www.aandnfireplaces.co.uk/product-category/pit-boss-grills/">Shop Pit Boss Products</a>
                <br>
                <br>
            </section>
        <!--<section class="features-icons bg-light text-center" id="dealer-section">-->
        ...
        <!--    <img src='https://images.pitboss-grills.com/catalog/icons/mapicon.png' style="max-width:40px;">-->
        <!--    <h3>ASDA </h3>-->
        <!--    <p class="font-weight-light mb-0">United Kingdom<br>-->
        <!--    </p><br><br>-->
        <!--    <a class="btn btn-dark" href="https://direct.asda.com/george/outdoor-garden/charcoal-bbqs/D33M03G01C01,default,sc.html">Shop Pit Boss Products</a><br><br>-->
        <!--</section>-->
        </div>
    </div>
</div>
