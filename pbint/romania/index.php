...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>GRILL EXPERT S.R.L.</h3>
            <p class="font-weight-light mb-0">IZLAZULUI STR. 6<br>
            CLUJ-NAPOCA ROMANIA 400655<br>
              <i class="icon-phone">0040745305694</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">contact@grill-expert.ro</span></i>
            </p>
            <a class="btn btn-dark" href="https://grill-expert.ro/brand/pit-boss/">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
    </div>
</div>
