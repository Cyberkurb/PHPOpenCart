...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>Sunsource Nje Ltd</h3>
            <p class="font-weight-light mb-0">Sunsource, 231, Naxxar Road, <br>
            Birkirkara Malta BKR9043<br>
              <i class="icon-phone"> 35627581303</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;"> info@sunsource.com.mt</span></i>
            </p>
            <a class="btn btn-dark" href="https://www.sunsource.com.mt/?s=pit+boss&post_type=product">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
    </div>
</div>
