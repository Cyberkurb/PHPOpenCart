...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>BARBECUE PARADISE</h3>
            <p class="font-weight-light mb-0">Strada Comunale da Bertolla all'Abbadia di Stura 176/4<br>
            Turin 10156 Italy<br>
              <i class="icon-phone">393806590728</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">torino@bbqparadise.it</span></i>
            </p>
            <a class="btn btn-dark" href="https://www.bbqparadise.it/catalogsearch/result/?q=pit+boss">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
    </div>
</div>
