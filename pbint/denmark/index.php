...
<div class="container">
    <div class="row">
        ...
        <!--    <h3>Camola ApS / frishop.dk</h3>-->
        <!--    <p class="font-weight-light mb-0">Nordensvej 2<br>-->
        <!--    Fredericia<br>-->
        <!--        Denmark 7000<br>-->
        <!--      <i class="icon-phone"> 4572207212</i><br>-->
        <!--      <i class="icon-envelope-open"> <span style="font-size:.9rem;">mail@frishop.dk</span></i>-->
        <!--    </p><br><br>-->
        <!--    <a class="btn btn-dark" href="http://www.frishop.dk">Shop Pit Boss Products</a><br><br>-->
        <!--</section>-->
        <!--</div>-->
        <div class="col-lg-3">
        <section class="features-icons bg-light text-center" id="dealer-section">
            <br>
            <img src='https://images.pitboss-grills.com/catalog/icons/mapicon.png' style="max-width:40px;">
            <h3>Homeshop <br><br></h3>
            <p class="font-weight-light mb-0">Vinkelvej 1<br>
            Kjellerup<br>
                Denmark 8620<br>
              <i class="icon-phone"> 87702525</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">salg@homeshop.dk</span></i>
            </p><br><br>
            <a class="btn btn-dark" href="https://www.homeshop.dk/pitboss/">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
</div><br>
<!--<div class="row">-->
...
<!--            <br>-->
<!--            <img src='https://images.pitboss-grills.com/catalog/icons/mapicon.png' style="max-width:40px;">-->
<!--            <h3>Kjellerup Tømmerhandel A/S </h3>-->
<!--            <p class="font-weight-light mb-0">Vinkelvej 1<br>-->
<!--            Kjellerup<br>-->
<!--                Denmark 8620<br>-->
<!--              <i class="icon-phone"> +45 87 70 25 00</i><br>-->
<!--              <i class="icon-envelope-open"> <span style="font-size:.9rem;">info@xl-kjellerup.dk</span></i>-->
<!--            </p><br><br>-->
<!--            <a class="btn btn-dark" href="http://kjellerup.xl-byg.dk/aabningstider/">Shop Pit Boss Products</a><br><br>-->
<!--        </section>-->
<!--        </div>-->
<!--        <div class="col-lg-4">-->
<!--        <section class="features-icons bg-light text-center" id="dealer-section">-->
<!--            <br>-->
<!--            <img src='https://images.pitboss-grills.com/catalog/icons/mapicon.png' style="max-width:40px;">-->
<!--            <h3>Tyndfilm.dk v/Peter Knudsen </h3>-->
<!--            <p class="font-weight-light mb-0">Industriparken 9<br>-->
<!--            Terndrup<br>-->
<!--                Denmark 9575<br>-->
<!--              <i class="icon-phone">  004561789360</i><br>-->
<!--              <i class="icon-envelope-open"> <span style="font-size:.9rem;">pk@tev-aps.dk</span></i>-->
<!--            </p><br><br>-->
<!--            <a class="btn btn-dark" href="http://www.tyndfilm.dk">Shop Pit Boss Products</a><br><br>-->
<!--        </section>-->
<!--        </div>-->
<!--        <div class="col-lg-4">-->
<!--        <section class="features-icons bg-light text-center" id="dealer-section">-->
<!--            <br>-->
<!--            <img src='https://images.pitboss-grills.com/catalog/icons/mapicon.png' style="max-width:40px;">-->
<!--            <h3>Scanheat A/S<br><br></h3>-->
<!--            <p class="font-weight-light mb-0">Gotlandsvej 22<br>-->
<!--            Horsens<br>-->
<!--                Denmark 8700<br>-->
<!--              <i class="icon-phone"> +45 7628 4100 </i><br>-->
<!--              <i class="icon-envelope-open"> <span style="font-size:.9rem;">info@scanheat.dk</span></i>-->
<!--            </p><br><br>-->
<!--            <a class="btn btn-dark" href="http://www.scanheat.dk">Shop Pit Boss Products</a><br><br>-->
<!--        </section>-->
<!--        </div>-->
<!--    </div>-->
</div>
