...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>Rédei és Szabó Kft.</h3>
            <p class="font-weight-light mb-0">8. Jenőhalom utca.<br>
            Budapest, Hungary 1163<br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">okosgrill@okosgrill.hu</span></i>
            </p>
            <a class="btn btn-dark" href="https://www.okosgrill.hu">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
    </div>
</div>
