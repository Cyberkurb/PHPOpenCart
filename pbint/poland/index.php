...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>Przedstawiciel handlowy - Poland - Pit Boss</h3>
            <p class="font-weight-light mb-0">Walcz <br>
            Západopomořanské vojvodství Poland 78600<br>
              <i class="icon-phone">48,604,179,628</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">dkarpinski@wp.pl</span></i>
            </p>
            <a class="btn btn-dark" href="https://www.pitboss.pl">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
    </div>
</div>
