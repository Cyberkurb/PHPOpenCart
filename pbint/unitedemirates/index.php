...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>Gulf Leisure BBQ General Trading LLC </h3>
            <p class="font-weight-light mb-0">Unit 5, Latifa Bint Hamdan Street, <br>
            Al Quoz Dubai United Arab Emirates 391374<br>
              <i class="icon-phone">+971 (0)4 379 1390</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">Calvin@gulf-leisure.com </span></i>
            </p>
            <a class="btn btn-dark" href="http://www.ourbbqrecipes.com">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
    </div>
</div>
