...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>AH-Trading GmbH</h3>
            <p class="font-weight-light mb-0">Lüttinger Str. 25<br>
            Xanten, NRW 46509 Germany<br>
              <i class="icon-phone">8004663235</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;">service@ah-trading.de</span></i>
            </p>
            <a class="btn btn-dark" href="https://www.gartenmoebel.de/index.php?lang=0&cl=search#/q/pit%20boss">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
    </div>
</div>
