...
<div class="container">
    <div class="row">
        ...
        <section class="features-icons bg-light text-center" id="dealer-section">
            ...
            <h3>Výhradní zastoupení -Česká Republika - PitBoss</h3>
            <p class="font-weight-light mb-0">Plumlovská 3614,<br>
                79601 Prostějov<br>
                Czech Republic<br>
              <i class="icon-phone"> 420732779911</i><br>
              <i class="icon-envelope-open"> <span style="font-size:.9rem;"> da.wa@seznam.cz</span></i>
            </p>
            <a class="btn btn-dark" href="https://www.udirny-pitboss.cz/sk/">Shop Pit Boss Products</a><br><br>
        </section>
        </div>
    </div>
</div>
