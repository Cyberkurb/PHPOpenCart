...
class Smtp {
	...
	public function send() {
		if ($this->from != $this->smtp_username) {
			$this->reply_to = $this->from;
			$this->reply_to_sender = $this->sender;
		...
		$this->smtp_hostname = 'tls://email-smtp.us-east-1.amazonaws.com';
		$handle = fsockopen('email-smtp.us-east-1.amazonaws.com', '587', $errno, $errstr, 30);
