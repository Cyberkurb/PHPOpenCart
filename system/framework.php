...
if ($config->get('db_autostart')) {
	...
	//$registry->set('readdb', new DB($config->get('db_engine'), $config->get('db_hostname_read'), $config->get('db_username'), $config->get('db_password'), $config->get('db_database'), $config->get('db_port')));
}
